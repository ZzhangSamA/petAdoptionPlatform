...
var showModal=function (object) {
    ...
    try{
        ...
        showModalHtml+=`<div class="xsw_modal-data" style="width:10%;  border-radius: 10px;  top: 50%;  left: 50%;  box-shadow: 0 2px 8px #555 ;  background-color: #fff;  border:1px solid #000;  padding:15px 0;  text-align:center;  z-index: 9999999999999999999999;  position: fixed;">
